    ...
    <div class=" h-[90vh] align-middle px-9 ">
        <div class="flex items-center w-full h-[100vh] justify-between">
            ...
            <div class="gap-3 flex flex-col justify-end">
                ...
                <nuxt-link to="https://telegram.org/bikiyam__">
                    <svg  xmlns="http://www.w3.org/2000/svg"  width="32"  height="32"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-brand-telegram text-white"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M15 10l-4 4l6 6l4 -16l-18 7l4 2l2 6l3 -4" /></svg>
                </nuxt-link>
                <nuxt-link to="https://www.instagram.com/bikiyam__">
